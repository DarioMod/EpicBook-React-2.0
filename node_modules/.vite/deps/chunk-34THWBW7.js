...
var divWithClassName_default = (className) => React3.forwardRef((p, ref) => (0, import_jsx_runtime2.jsx)("div", {
  ...p,
  ref,
...
var AlertHeading = React4.forwardRef(({
  className,
  bsPrefix,
...
function useMounted() {
  const mounted = (0, import_react12.useRef)(true);
  const isMounted = (0, import_react12.useRef)(() => mounted.current);
...
var Button = React5.forwardRef((_ref, ref) => {
  ...
  return (0, import_jsx_runtime4.jsx)(Component, Object.assign({}, props, buttonProps, {
    ref
  }));
});
...
var AlertLink = React7.forwardRef(({
  className,
  bsPrefix,
...
var TransitionWrapper = import_react20.default.forwardRef(({
  onEnter,
  onEntering,
  onEntered,
  onExit,
  ...
  const handleEnter = (0, import_react20.useCallback)(normalize(onEnter), [onEnter]);
  const handleEntering = (0, import_react20.useCallback)(normalize(onEntering), [onEntering]);
  const handleEntered = (0, import_react20.useCallback)(normalize(onEntered), [onEntered]);
  const handleExit = (0, import_react20.useCallback)(normalize(onExit), [onExit]);
  const handleExiting = (0, import_react20.useCallback)(normalize(onExiting), [onExiting]);
  const handleExited = (0, import_react20.useCallback)(normalize(onExited), [onExited]);
  const handleAddEndListener = (0, import_react20.useCallback)(normalize(addEndListener), [addEndListener]);
  return (0, import_jsx_runtime7.jsx)(Transition_default, {
    ref,
    ...props,
    onEnter: handleEnter,
...
var Alert = React13.forwardRef((uncontrolledProps, ref) => {
  ...
  return (0, import_jsx_runtime10.jsx)(Transition2, {
    unmountOnExit: true,
    ...props,
    ref: void 0,
    in: show,
...
object-assign/index.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-34THWBW7.js.map
